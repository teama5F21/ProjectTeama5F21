...
const cacheName = '_75ProjectTeama3-2021-11-02 13:08:36.325399'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeama3'.length) === '_75ProjectTeama3') {
